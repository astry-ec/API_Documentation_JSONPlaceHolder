...
In this repositories, I will use JsonPlaceHolder API from https://jsonplaceholder.typicode.com/ to be an example and role as API company that is readily used by external company/application

# Table of Contents
* [1. API Overview](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#1-api-overview)
* [2. Use Cases](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#2-use-cases)
* [3. Authorizations](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#3-authorizations)
* [4. Available Endpoints](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#4-available-endpoints)
      - [/posts](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#posts)
      - [/comments](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#comments)
      - [/albums](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#albums)
      - [/photos](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#photos)
      - [/todos](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#todos)
      - [/users](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#users)
* [5. Limitations](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#5-limitations)
* [6. API Postman Collection](https://github.com/astry-ec/API_Documentation_JSONPlaceHolder/blob/main/README.md#6-api-postman-collection)
